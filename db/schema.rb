...
ActiveRecord::Schema.define(:version => 20140123204057) do
  ...
  add_index "cats", ["user_id"], :name => "index_cats_on_user_id", :unique => true
  ...
  add_index "session_tokens", ["token"], :name => "index_session_tokens_on_token", :unique => true
